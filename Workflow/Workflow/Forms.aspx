    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div id="content-body">
            ...
            <div runat="server" id="formListing">
                ...
                <asp:Button runat="server" ID="Button2" Text="Show 10 More..." OnClick="LoadMoreForms" CssClass="fluid ui button" />
            </div>
            ...
            <div runat="server" id="formBuilder" visible="false">
                ...
                <div id="CreateFormBtnDiv">
                    ...
                    <p>Select the role(s) required to approve this form</p>
                    <br />
                    ...
                    <asp:DropDownList runat="server" ID="FormApproval4" Visible="false" OnSelectedIndexChanged="FormApproval_SelectedIndexChanged" onchange="saveSelection()" CssClass="form-selector-dropdown" /><br />
                    <br />
            ...
            <div runat="server" id="formViewer" visible="false">
                ...
                <asp:Label runat="server" ID="approvalLabel4" Visible="false"></asp:Label><br />
                <br />
